...
class PpskService
{
     ...
     * opt-in alongside auto-generate as of 2026-07-17). Either way the
     * value passes through Psk::fromString() before it is ever persisted.
     * Returns the group and the cleartext PSK for one-time display.
     *
     * @return array{group: PpskGroup, psk: string}
     */
    public function create(string $label, int $vlanId, bool $enabled, ?string $adminUser, ?string $manualPsk = null): array
    {
